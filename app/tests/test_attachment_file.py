...
CONTACT_ID = "997248000000673164"  # the "Marrier (Sample)" contact from your last test

# 1. Create a small dummy file to upload
dummy_path = "dummy_test_file.txt"
with open(dummy_path, "w") as f:
    f.write("CandyVoice Zoho attachment test — safe to delete.")

# 2. Upload it via the existing service function
try:
...
# 3. Verify by listing attachments on the contact
